...
T8_DIRECTOR_WORKBENCH = "/extensions/minimax-h3-audio-T8/director/workbench.mjs"
...
def check_contract(
    ...
    *,
    ...
    workbench = request(_url(comfy_url, T8_DIRECTOR_WORKBENCH))
    workbench_text = workbench.body.decode("utf-8", "replace")
    if "createDirectorWorkbench" not in workbench_text:
        raise RuntimeError("T8 Obsidian Director workbench extension module is unavailable")
